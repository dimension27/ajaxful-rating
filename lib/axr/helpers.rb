module AjaxfulRating # :nodoc:
  module Helpers
    ...
    # * <tt>:list_class</tt> Any extra classes to add to the <ul class="ajaxful-rating"> tag
    # 
    # Example:
    ...
    def ratings_for(*args)
      ...
      options = args.extract_options!.symbolize_keys.slice(:small, :remote_options,
        :wrap, :show_user_rating, :dimension, :force_static, :current_user, :disable_remote, :to_nearest, :star_class,:list_class)
